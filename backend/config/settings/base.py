...
# Notifications
NOTIFICATION_CHANNELS = ['in_app', 'email']  # 'sms' can be added later

# SMS Service (adapter pattern - pluggable)
SMS_BACKEND = config('SMS_BACKEND', default='apps.notifications.sms.backends.console.ConsoleSMSBackend')
SMS_PROVIDER_API_KEY = config('SMS_PROVIDER_API_KEY', default='')
SMS_FROM_NUMBER = config('SMS_FROM_NUMBER', default='')
